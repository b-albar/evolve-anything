...
META_STEP2_USER_MSG = (
    ...
    "Make sure to incorporate the previous insights and the NEW research insights into the analysis.\n\n"
    ...
    "- Synthesize relevant ideas from the web search results\n"
    "- Explain how these external ideas could apply to the current program\n"
    "- Assess their potential based on the current program's state\n\n"
    ...
    "research findings, previous insights, and the current best program information. "
...
META_RESEARCH_QUERY_SYSTEM_MSG = (
    "You are an expert researcher. Your goal is to generate search queries to "
    "find novel ideas and algorithms that could improve the current best program."
)

META_RESEARCH_QUERY_USER_MSG = (
    "# Previous Insights & Experimentation History\n"
    "{previous_insights}\n\n"
    "# Current Best Program\n"
    "{best_program_info}\n\n"
    "# Goal\n"
    "We are trying to improve this program. Based on what has been tried previously (see Insights) "
    "You can perform two types of actions:\n"
    "1. **SEARCH**: [query] - To search for information.\n"
    "2. **READ**: [url] - To read a specific webpage (e.g. arXiv paper, article).\n\n"
    "Return ONLY 3 lines, each starting with either 'SEARCH: ' or 'READ: '."
)

META_RESEARCH_SUMMARY_SYSTEM_MSG = (
    "You are an expert researcher. Summarize the search results to provide "
    "actionable ideas for improving the program."
)

META_RESEARCH_SUMMARY_USER_MSG = (
    "# Search Results\n"
    "{search_results}\n\n"
    "# Current Best Program Approach\n"
    "{best_program_info}\n\n"
    "# Instructions\n"
    "Extract 2-3 key ideas, algorithms, or techniques from the search results "
    "that could be applicable to improving the current program.\n"
    "For each idea, provide:\n"
    "1. A brief explanation of the concept.\n"
    "2. **Implementation Details**: Include necessary mathematical formulas (LaTeX style) or short code snippets to facilitate implementation.\n\n"
    "Focus on novelty, relevance, and actionability."
)
