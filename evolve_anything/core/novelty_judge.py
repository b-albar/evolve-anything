...
from evolve_anything.prompts import NOVELTY_SYSTEM_MSG, NOVELTY_USER_MSG
...
class NoveltyJudge:
            ...
            if self.novelty_llm_client is not None:
                ...
                if most_similar_program:
                    try:
                        ...
                        is_novel, explanation = self.check_llm_novelty(
    ...
    def check_llm_novelty(
        ...
        if not self.novelty_llm_client:
            ...
            return True, "No novelty LLM configured"
        ...
        try:
            ...
            if response is None or response.content is None:
                ...
                return True, "LLM response was empty"
            ...
            explanation = content
            return is_novel, explanation

        except Exception as e:
            logger.error(f"Error in novelty LLM check: {e}")
            return True, f"Error in novelty check: {e}"
